...
export default function ForgotPasswordForm() {
  ...
  function handleSubmit() {
    ...
    http.post('/forgot-password', { email })
      .then(() => {
        setSubmitting(false);
        logout(); // logout user if they were logged in
        setError('');
        setShowSuccess(true);
      })
      .catch((e) => {
    ...
    <div className="flex flex-col justify-center py-12 lg:mt-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-6 text-center text-lg text-gray-700">
          No problem, it happens to the best of us. Just enter your email address below and we&apos;ll send you a link to reset your password.
        </p>
      </div>
